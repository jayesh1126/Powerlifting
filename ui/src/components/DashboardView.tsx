...
// This function is to calculate the One Rep Max from one set based on the RPE Chart
interface RpeChart {
...
const calculateOneRepMax = async (setData: SetModel) => {
  ...
  const rpe = Number(setData.rpe).toString(); // Ensure RPE is in a format like '10', '9.5', etc.
